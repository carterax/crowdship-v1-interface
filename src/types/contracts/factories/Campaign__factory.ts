...
const _abi = [
  ...
  {
    inputs: [],
    name: "campaignRequestContract",
    outputs: [
      {
        internalType: "contract ICampaignRequest",
        name: "",
        type: "address",
      },
    ],
  ...
  {
    inputs: [],
    name: "campaignRewardContract",
    outputs: [
      {
        internalType: "contract ICampaignReward",
        name: "",
        type: "address",
      },
    ],
  ...
  {
    inputs: [],
    name: "campaignVoteContract",
    outputs: [
      {
        internalType: "contract ICampaignVote",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    ...
    name: "timeUntilNextTransferConfirmation",
    outputs: [
      {
        internalType: "uint256",
        name: "",
