...
export class CampaignReward__factory {
  static readonly abi = _abi;
  static createInterface(): CampaignRewardInterface {
    return new utils.Interface(_abi) as CampaignRewardInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CampaignReward {
    return new Contract(address, _abi, signerOrProvider) as CampaignReward;
  }
}
