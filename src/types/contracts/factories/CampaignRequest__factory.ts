...
export class CampaignRequest__factory {
  static readonly abi = _abi;
  static createInterface(): CampaignRequestInterface {
    return new utils.Interface(_abi) as CampaignRequestInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CampaignRequest {
    return new Contract(address, _abi, signerOrProvider) as CampaignRequest;
  }
}
